...
<body>
<div class="container">
    <center><h3>添加会员页面</h3></center>
    <form action="${pageContext.request.contextPath}/addMermbersServlet" method="post">
        <div class="form-group">
            <label for="mname">姓名：</label>
            <input type="text" class="form-control" id="mname" name="mname" placeholder="请输入姓名">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="money" name="money" placeholder="请输入"/>
        </div>
